...
public class LogWindow extends JTextPane implements Serializable {
    File savedFile = null;
    boolean changed = false; // whether there is any unsaved changes
    ...
    public LogWindow(Statcato mTab) {
        ...
        addKeyListener(new KeyAdapter() {
            ...
            public void keyTyped(KeyEvent e) {
                if (e.getKeyChar() == '\n') {
                    ...
                    try {
                        ...
                        setChangedStatus();
                        String txt = getText(); // refresh the text
                        setText("");
                        setText(txt);
            ...
            public void keyPressed(KeyEvent e) {
                if (e.isControlDown() && e.getKeyCode() == KeyEvent.VK_V) { // paste
                        setChangedStatus();
                }
            }
            @Override
    ...
    private void initialize() {
        ...
        // change the font face to san-serif
    ...
    public void setUnchangedStatus() {
        ...
        if (title.endsWith("*"))
            app.setLogTitle(app.getLogTitle().substring(0, title.length()-1));
    }
