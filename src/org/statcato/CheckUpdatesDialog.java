 ...
 *
 * Created on Apr 28, 2009, 3:21:43 PM
 */
...
public class CheckUpdatesDialog extends StatcatoDialog {
    ...
    public CheckUpdatesDialog(java.awt.Frame parent, boolean modal) {
        ...
        if (currentVersion.equals("error")) {
            CurrentVersionLabel.setText("Error obtaining the current " +
                    "number from web.  Check network connection.");
        }
            ...
            CurrentVersionLabel.setText(
                    "<html>New version " + currentVersion +
                    " is available.<br>" +
                    "  Visit " +
                    "http://www.statcato.org to obtain the latest" +
                    " version.</html>");
        ...
        String fileName = "statcato_" + currentVersion + ".zip";
            ...
            if (returnValue == JFileChooser.APPROVE_OPTION) {
                ...
                DownloadFile d = new DownloadFile(
                    "http://www.statcato.org/versions/statcato_" + currentVersion +
                    ".zip");
                ...
                if (totalDownload <= 0) {
                    ...
                    JOptionPane.showMessageDialog(this,
                            "The latest version is downloaded to " +
                            path,
                            "Download complete",
