 ...
 * 
 * Modified to work with Cut in a spreadsheet.
 * 
...
public void setJTable(Spreadsheet jTable1) {this.jTable1=jTable1;}
   /**
...
(numcols-1==colsselected[colsselected.length-1]-colsselected[0] &&
                numcols==colsselected.length)))
         {
            JOptionPane.showMessageDialog(null, "Invalid Cut Selection",
                                          "Invalid Cut Selection",
                                          JOptionPane.ERROR_MESSAGE);
            return;
         }
         for (int i=0;i<numrows;i++)
