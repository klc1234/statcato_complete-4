...
/**
 * Abtract base class for different types of
 * discrete probability distributions.  Subclasses must implement density and
...
public abstract class DiscreteProbabilityDistribution {
    ...
    public Double inverseCumulativeProbability(double x1, double x2, double tol, 
        ...
        for (iter=1;iter<=ITMAX;iter++) {
            ...
            {
                return new Double(Math.floor(b+0.5)); // round to nearest integer
            }
        ...
        return new Double(0);                                               // Never get here.        
    }
}
