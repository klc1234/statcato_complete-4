/*
 * IntegerDistributionDialog.java
 *
 * Created on May 19, 2008, 8:28 AM
 */
...
/**
 * A dialog for integer probability distribution, specified by 
 ...
 * @since 1.0
 */
public class IntegerDistributionDialog extends StatcatoDialog {

    /** Creates new form IntegerDistributionDialog */
    public IntegerDistributionDialog(java.awt.Frame parent, boolean modal,
            Statcato app) {
        super(parent, modal);
        this.app = app;
        ...
        setHelpFile("calc-integer");
        name = "Integer Probability Distribution";
        description = "For calculations on integer probability distribution.";
        helpStrings.add("Enter integers for the minimum and maximum of the " +
                "distribution." );
    ...
    private void initComponents() {
        ...
        setTitle("Integer Probability Distribution");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(MinTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE))))
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(ColumnComboBox, 0, 108, Short.MAX_VALUE)))
    ...
    private void OKButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKButtonActionPerformed
        app.compoundEdit = new DialogEdit("integer pdf");
        
        int min = 0, max = 0;
        
        String heading = "Integer Distribution: ";
        String text = "";
        // get degrees of freedom from dialog
        try {
            min = Integer.parseInt(MinTextField.getText());
        } catch (NumberFormatException e) {
            app.showErrorDialog("Enter a valid number for the minimum.");
            return;
        }
        ...
        try {
            ...
            app.showErrorDialog("Enter a valid number for the maximum.");
            return;
        }
        if (min >= max) {
            app.showErrorDialog("The maximum value must be strictly greater than the minimum.");
            return;
        }
        
        heading += "minimum=" + min + ", maximum=" + max;
        ...
        // compute results
        IntegerProbabilityDistribution npd = new IntegerProbabilityDistribution(min, max);
        ...
        if (ProbDensityRadioButton.isSelected()) {
            ...
            for (int i = 0; i < ColumnVector.size(); ++i) {
                ...
                if (elm != null) {
                    ...
                    Integer x = npd.inverseCumulativeProbability(area);
                    if (x == null) {
                        ...
                        text += "<tr><td>" + area + "</td><td>" +
                                    x.toString() + "</td></tr>";
                        ResultVector.addElement(x.intValue() + "");   
                    }
                }
            }
            text += "</table>";
