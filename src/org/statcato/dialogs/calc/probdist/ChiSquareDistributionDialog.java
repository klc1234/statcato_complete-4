/*
 * ChiSquareDistributionDialog.java
 *
 ...
 * @since 1.0
 */
public class ChiSquareDistributionDialog extends StatcatoDialog {

    /** Creates new form ChiSquareDistributionDialog */
    public ChiSquareDistributionDialog(java.awt.Frame parent, boolean modal, 
            Statcato app) {
        super(parent, modal);
        this.app = app;
        ...
        setHelpFile("calc-chisquare");
        name = "Chi-Square Probability Distribution";
        description = "For calculations on Chi-square probability distribution.";
    ...
    private void initComponents() {
        ...
        setTitle("Chi-Square Probability Distribution");
    ...
    private void OKButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKButtonActionPerformed
        app.compoundEdit = new DialogEdit("chi square pdf");
        int DOF = 0;
        String heading = "Chi Square Distribution: DOF = ";
        String text = "";
        ...
        // compute results
        ChiSquareProbabilityDistribution npd = new ChiSquareProbabilityDistribution(DOF);
