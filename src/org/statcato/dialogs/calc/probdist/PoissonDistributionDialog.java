/*
 * PoissonDistributionDialog.java
 *
 * Created on May 15, 2008, 2:50 PM
 */
 ...
 * @since 1.0
 */
public class PoissonDistributionDialog extends StatcatoDialog {

    /** Creates new form PoissonDistributionDialog */
    public PoissonDistributionDialog(java.awt.Frame parent, boolean modal,
            Statcato app) {
        super(parent, modal);
        this.app = app;
        ...
        setHelpFile("calc-poisson");
        name = "Poisson Probability Distribution";
        description = "For calculations on Poisson probability distribution.";
        helpStrings.add("Enter the mean of the Poisson distribution.");
    ...
    private void initComponents() {
        ...
        setTitle("Poisson Probability Distribution");
    ...
    private void OKButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKButtonActionPerformed
        app.compoundEdit = new DialogEdit("poisson pdf");
        
        double mean = 0;

        String heading = "Poisson Distribution: ";
        String text = "";
        // get degrees of freedom from dialog
        try {
            mean = Double.parseDouble(nTextField.getText());
        } catch (NumberFormatException e) {
            app.showErrorDialog("Enter a valid number for the mean.");
            return;
        }
        if (mean <= 0) {
            app.showErrorDialog("The mean must be a positive number.");
            return;
        }
        ...
        // compute results
        PoissonProbabilityDistribution npd = new PoissonProbabilityDistribution(mean);
