/*
 * FDistributionDialog.java
 *
 * Created on May 13, 2008, 1:03 PM
 */
 ...
 * @since 1.0
 */
public class FDistributionDialog extends StatcatoDialog {

    /** Creates new form FDistributionDialog */
    public FDistributionDialog(java.awt.Frame parent, boolean modal,
            Statcato app) {
        super(parent, modal);
        this.app = app;
        ...
        description = "For calculations on F probability distribution.";
        helpStrings.add("Enter positive integers for the degrees of freedom." +
    ...
    private void initComponents() {
        ...
        DOF1TextField = new javax.swing.JTextField();
        InvCumProbRadioButton = new javax.swing.JRadioButton();
        DOF2TextField = new javax.swing.JTextField();
        ...
        setTitle("F Probability Distribution");
        ...
        DOF1TextField.setText("1");

        InvCumProbRadioButton.setText("Inverse cumulative probability");

        DOF2TextField.setText("1");

        jLabel2.setText("Numerator degrees of freedom:");

        CumProbRadioButton.setText("Cumulative probability");

        jLabel3.setText("Denominator degrees of freedom:");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(DOF2TextField)
                            .addComponent(DOF1TextField, javax.swing.GroupLayout.PREFERRED_SIZE, 91, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(73, Short.MAX_VALUE))
        );

        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {DOF1TextField, DOF2TextField});
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(DOF1TextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(DOF2TextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(19, 19, 19)
                .addComponent(jLabel4)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(ProbDensityRadioButton)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(ColumnComboBox, 0, 102, Short.MAX_VALUE)))
    ...
    private void OKButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OKButtonActionPerformed
        app.compoundEdit = new DialogEdit("F pdf");
        
        int DOF1 = 0, DOF2 = 0;
        String heading = "F Distribution: DOF = ";
        String text = "";
        // get degrees of freedom from dialog
        try {
            DOF1 = Integer.parseInt(DOF1TextField.getText());
        } catch (NumberFormatException e) {
            app.showErrorDialog("Enter a valid number for the numerator degrees of freedom.");
            return;
        }
        try {
            DOF2 = Integer.parseInt(DOF2TextField.getText());
        } catch (NumberFormatException e) {
            app.showErrorDialog("Enter a valid number for the denominator degrees of freedom.");
            return;
        }
        if (DOF1 < 1 || DOF2 < 1) {
            app.showErrorDialog("Enter valid degrees of freedom.");
            return;
        }
        ...
        // compute results
        FProbabilityDistribution npd = new FProbabilityDistribution(DOF1, DOF2);
    ...
    private javax.swing.JTextField DOF1TextField;
    private javax.swing.JTextField DOF2TextField;
